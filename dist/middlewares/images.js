 ...
 * @param next
 */
var imageCaching = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fs_1.promises.readFile(imagePath)
                        .then(function (file) { return __awaiter(void 0, void 0, void 0, function () {
                        var metadata;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, sharp_1.default)(file).metadata()];
                                case 1:
                                    metadata = _a.sent();
